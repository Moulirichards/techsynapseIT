                ...
                <div className="space-y-3 md:space-y-6">
                  ...
                  <div className="flex items-start space-x-2 md:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white text-xs md:text-base">info@infocera.in</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-2 md:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white text-xs md:text-base">8th Floor, HB Twin Tower<br />Netaji Subhash Place, Pitampura<br />NEW DELHI - 110034</p>
                    </div>
                  </div>
